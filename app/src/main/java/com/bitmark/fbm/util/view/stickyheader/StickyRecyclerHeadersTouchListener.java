...
public class StickyRecyclerHeadersTouchListener implements RecyclerView.OnItemTouchListener {
    ...
    private final com.bitmark.fbm.util.view.stickyheader.StickyRecyclerHeadersDecoration mDecor;
    ...
    public com.bitmark.fbm.util.view.stickyheader.StickyRecyclerHeadersAdapter getAdapter() {
        if (mRecyclerView.getAdapter() instanceof com.bitmark.fbm.util.view.stickyheader.StickyRecyclerHeadersAdapter) {
            return (com.bitmark.fbm.util.view.stickyheader.StickyRecyclerHeadersAdapter) mRecyclerView.getAdapter();
        } else {
