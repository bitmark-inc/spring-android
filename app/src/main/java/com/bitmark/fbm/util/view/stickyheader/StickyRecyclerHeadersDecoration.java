package com.bitmark.fbm.util.view.stickyheader;
...
import com.bitmark.fbm.util.view.stickyheader.caching.HeaderProvider;
import com.bitmark.fbm.util.view.stickyheader.caching.HeaderViewCache;
import com.bitmark.fbm.util.view.stickyheader.calculation.DimensionCalculator;
import com.bitmark.fbm.util.view.stickyheader.rendering.HeaderRenderer;
import com.bitmark.fbm.util.view.stickyheader.util.LinearLayoutOrientationProvider;
import com.bitmark.fbm.util.view.stickyheader.util.OrientationProvider;
...
public class StickyRecyclerHeadersDecoration extends RecyclerView.ItemDecoration {
    ...
    public StickyRecyclerHeadersDecoration(com.bitmark.fbm.util.view.stickyheader.StickyRecyclerHeadersAdapter adapter) {
        this(adapter, new LinearLayoutOrientationProvider(), new DimensionCalculator(), null);
    }

    public StickyRecyclerHeadersDecoration(com.bitmark.fbm.util.view.stickyheader.StickyRecyclerHeadersAdapter adapter, ItemVisibilityAdapter visibilityAdapter) {
        this(adapter, new LinearLayoutOrientationProvider(), new DimensionCalculator(), visibilityAdapter);
    }

    private StickyRecyclerHeadersDecoration(com.bitmark.fbm.util.view.stickyheader.StickyRecyclerHeadersAdapter adapter, OrientationProvider orientationProvider,
    ...
    private StickyRecyclerHeadersDecoration(com.bitmark.fbm.util.view.stickyheader.StickyRecyclerHeadersAdapter adapter, OrientationProvider orientationProvider,
        ...
        this(adapter, headerRenderer, orientationProvider, dimensionCalculator, headerProvider,
                new com.bitmark.fbm.util.view.stickyheader.HeaderPositionCalculator(adapter, headerProvider, orientationProvider,
